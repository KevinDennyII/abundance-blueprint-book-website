      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
              <motion.div 
                ...
                className="max-w-xl"
              >
                <motion.span variants={fadeInUp} className="inline-block py-1 px-3 rounded-full bg-secondary/20 text-secondary-foreground text-sm font-medium tracking-wider uppercase mb-6">
                  New Release
                </motion.span>
                <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl lg:text-6xl font-serif text-primary leading-tight mb-6">
                  Heal Your Past. <br />
                  <span className="text-secondary">Build Your Foundation.</span> <br />
                  Create Financial Harmony.
                </motion.h1>
                <motion.p variants={fadeInUp} className="text-lg text-muted mb-8 leading-relaxed">
                  A memoir-driven guide to healing the story beneath the spending, debt, hustle, fear, and financial exhaustion.
                </motion.p>
        ...
        <section className="py-24 bg-primary text-primary-foreground text-center px-4">
          ...
          >
            ...
            <p className="font-sans tracking-widest uppercase text-sm opacity-80">— La'Toya Ray, CPA</p>
          </motion.div>
        </section>
        ...
        <section className="py-24 bg-card px-4">
          <div className="container mx-auto">
            ...
            >
              <motion.h2 variants={fadeInUp} className="font-serif text-3xl md:text-5xl text-primary mb-6">
                The HEALS™ Framework
              </motion.h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              {[
                ...
                >
                  <span className="font-serif text-5xl text-secondary block mb-4">{item.letter}</span>
            ...
            <div className="text-center mt-12">
              <Link href="/about" className="inline-block font-sans text-sm font-medium tracking-wide uppercase text-primary border-b border-primary pb-1 hover:text-secondary hover:border-secondary transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="p-12 text-center relative z-10">
                   <p className="font-serif text-2xl text-primary italic opacity-60">"True wealth is not performative. It is quiet peace."</p>
                </div>
              </motion.div>
              <motion.div 
                initial="hidden"
                ...
                className="max-w-lg"
              >
                <motion.h2 variants={fadeInUp} className="font-serif text-3xl md:text-4xl text-primary mb-6">
                  Meet La'Toya Ray
                </motion.h2>
                ...
                <motion.p variants={fadeInUp} className="text-muted leading-relaxed mb-8">
                  She built a million-dollar real estate portfolio from food stamps, a loan modification, and a woman named Ms. Ruth who co-signed a car.
                </motion.p>
                <motion.div variants={fadeInUp}>
                  <Link href="/about" className="inline-block px-6 py-3 bg-primary text-primary-foreground rounded hover:bg-primary/90 transition-colors font-medium">
                    Read Her Story
                  </Link>
                </motion.div>
              </motion.div>
